...

{
  ...
  form: [
  {
    label: "Team Name",
    type: "text",
    placeholder: "Note: Team name should not be a franchise name"
  },
...

{
  ...
  desc1: "Pitch your startup idea to a panel of investors and industry experts.",
...

  {
    ...
    accept: "image/*"
     ...
     { label: "Description",placeholder:"1. Startup/Idea Name 2.problem statement 3.Domain", type: "textarea" }
  ]
},
